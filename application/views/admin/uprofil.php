			...
			<div class="card-content">
				...
				<div class="input-group col-sm-8">
					...
					<div class="form-group label-floating">
						...
						<input type="number" name="noid" class="form-control" value="<?php echo $alumni->no_identitas?>" required>
					</div>
				</div>
				<div class="input-group col-sm-6">
					...
					<div class="form-group label-floating">
						...
						<input type="number" name="nim" class="form-control" value="<?php echo $alumni->nim?>" required>
					</div>
				</div>
				<!-- <div class="input-group col-sm-8">
					<span class="input-group-addon"><i class="material-icons">recent_actors</i></span>
					<div class="form-group label-floating">
						...
						<input type="number" name="nisn" class="form-control" value="<?php echo $alumni->nisn?>" required>
					</div>
				</div> -->
				<div class="input-group col-sm-12">
					...
					<div class="form-group label-floating">
						...
						<input type="text" name="nama" class="form-control" value="<?php echo $alumni->nama?>" onkeypress="return angkadanhuruf(event,'qwertyuioplkjhgfdsazxcvbnmMNBVCXZASDFGHJKLPOIUYTREWQ ',this)" required>
					</div>
				</div>
				<div class="input-group col-sm-12">
					...
					<div class="form-group label-floating">
						...
						<input type="text" name="tlahir" class="form-control" value="<?php echo $alumni->tempat_lahir?>" required>
					</div>
				</div>
				<div class="input-group col-sm-8">
					...
					<div class="form-group label-floating">
						...
						<input type="text" name="tgllahir" class="form-control datepicker" value="<?php echo date("d-m-Y",$alumni->tgl_lahir)?>" required>
					</div>
				</div>
				...
				<div class="input-group col-sm-12">
					...
					<div class="form-group label-floating">
						...
						<input type="text" name="alamat" class="form-control" value="<?php echo $alumni->alamat_skrg?>" required>
					</div>
				</div>
				<div class="input-group col-sm-8">
					...
					<div class="form-group label-floating">
						...
						<input type="text" name="status" class="form-control" value="<?php echo $alumni->status?>" onkeypress="return angkadanhuruf(event,'qwertyuioplkjhgfdsazxcvbnmMNBVCXZASDFGHJKLPOIUYTREWQ ',this)" required>
					</div>
				</div>
				<div class="input-group col-sm-8">
					...
					<div class="form-group label-floating">
						...
						<input type="number" name="telp" class="form-control" value="<?php echo $alumni->telp?>" required>
					</div>
				</div>
				<div class="input-group col-sm-8">
					...
					<div class="form-group label-floating">
						...
						<input type="text" name="nm_perusahaan" class="form-control" value="<?php echo $alumni->nm_perusahaan?>" onkeypress="return angkadanhuruf(event,'qwertyuioplkjhgfdsazxcvbnmMNBVCXZASDFGHJKLPOIUYTREWQ ',this)" required>
					</div>
				</div>
				<div class="input-group col-sm-8">
					<span class="input-group-addon"><i class="material-icons">home</i></span>
					<div class="form-group label-floating">
						...
						<input type="text" name="alamat_perusahaan" class="form-control" value="<?php echo $alumni->alamat_perusahaan?>" required>
					</div>
				</div>
				<div class="input-group col-sm-12">
					...
					<div class="form-group label-floating">
						...
						<input type="text" name="pekerjaan" class="form-control" value="<?php echo $alumni->pekerjaan?>" onkeypress="return angkadanhuruf(event,'qwertyuioplkjhgfdsazxcvbnmMNBVCXZASDFGHJKLPOIUYTREWQ ',this)" required>
					</div>
				</div>
				<div class="input-group col-sm-12">
