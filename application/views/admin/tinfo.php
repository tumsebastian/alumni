<form action="<?php echo base_url('proses/tinfo/'.$jns)?>" method="post">
<div class="col-md-12">
	<div class="card">
		...
		<div class="card-content">
			<h4 class="card-title">Tambah Data <?php if ($jns=='iu'){echo "Informasi Umum";}else{echo "Karir Center";}?></h4>
			<form method="post" action="<?php echo base_url().'proses/tinfo/'.$jns?>">
