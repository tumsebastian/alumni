...
<head>
    <meta charset="utf-8" />
    <link rel="icon" type="image/png" href="<?php echo base_url()?>assets/img/jic-logo2.png" />
...
<body>
  <div class="wrapper">
        <div class="sidebar" data-active-color="red" data-background-color="white" data-image="<?php echo base_url()?>assets/img/bg.jpg">
            <!--
    ...
    -->
            ...
            <div class="sidebar-wrapper">
                <div class="user">
                    <div class="photo">
											<img src="<?php echo base_url()?>assets/img/jic-logo3.png" />
                    </div>
                    <div class="info">
                ...
                <ul class="nav">
                    <li class="<?php echo $menu['m1']?>">
                        ...
                        <div class="collapse" id="beranda">
                            <ul class="nav">
                                <li>
                                    <a href="<?php echo base_url('admin/index/iu')?>">
                                        <span class="sidebar-mini">IU</span>
                                        <span class="sidebar-normal">Info Umum</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url('admin/index/ik')?>">
                    ...
                    <li class="<?php echo $menu['m3']?>">
                        <a href="<?php echo base_url('admin/data_alumni')?>">
