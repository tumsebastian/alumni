	...
	<div class="col-md-4">
		<div class="card card-profile">
			...
			<div class="card-footer">
				...
				<a href="<?php echo base_url('alumni/uprofil/'.nura_enc($alumni->no_identitas))?>" class="btn btn-warning">Ubah Profil</a>
				<a href="<?php echo base_url('alumni/uakun/'.nura_enc($alumni->no_identitas))?>" class="btn btn-warning">Ubah Sandi</a>
				<?php }?>
			</div>
		</div>
	</div>