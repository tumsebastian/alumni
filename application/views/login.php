...
<div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
	<form method="post" action="<?php echo base_url('proses/login/alumni')?>">
		<div class="card card-login card-hidden">
			<div class="card-header text-center">
				<h4 class="card-title"><img src="<?php echo base_url()?>assets/img/jic-logo.png" style="width:120px !important"> STIE JIC ALUMNI</h4>
			</div><hr>
			<div class="card-content">
				<div class="input-group">
					<span class="input-group-addon"><i class="material-icons">recent_actors</i></span>
					<div class="form-group label-floating">
						<label class="control-label">NIM Alumni</label>
			...
			<div class="footer text-center">
				<button type="submit" class="btn btn-success btn-round btn-lg">Masuk</button>
				<p style="color:black">Belum punya Akun.? <a href="<?php echo base_url('index/daftar')?>">Klik disini</a></p>
			</div>
		</div>
	</form>
</div>
